...
$translations = [
    ...
    "shortTitle" => "Qualität und Präzision im Estrichbau",
    "description" => "NAZET GmbH steht für exzellenten Estrichbau und erstklassige Dämmungslösungen. Mit jahrelanger Erfahrung und einem starken Fokus auf Qualität bieten wir professionelle Estrich- und Dämmarbeiten, die höchsten Ansprüchen gerecht werden. Ob Neubau, Renovierung oder Spezialanwendungen – unsere maßgeschneiderten Lösungen sorgen für eine stabile, energieeffiziente Basis in jedem Bauprojekt.",

    "powerKey1" => "<strong>Breites Leistungsspektrum:</strong> Vom Zementestrich bis zur Feuchtigkeitssperre bieten wir eine umfassende Palette an Estrich- und Dämmleistungen.",
    "powerKey2" => "<strong>Fachkompetenz und Erfahrung:</strong> Unser Team arbeitet mit höchster Präzision und Fachkenntnis für dauerhafte Qualität.",
    "powerKey3" => "<strong>Nachhaltige Lösungen:</strong> Energiesparende Wärmedämmungen und Trittschalldämmungen für mehr Effizienz und Komfort.",
    "powerKey4" => "<strong>Kundenzufriedenheit:</strong> Wir legen großen Wert auf zuverlässigen Service und Lösungen, die exakt auf Ihre Bedürfnisse abgestimmt sind.",

    "closingText" => "Vertrauen Sie auf NAZET GmbH, wenn es um professionelle Estrich- und Dämmarbeiten geht. Wir stehen für Qualität und Kundenzufriedenheit – die beste Basis für Ihr Projekt!",
    ...
    "missionEngagingTitle" => "Fundament für Qualität und Beständigkeit",
    "missionDescription" => "Wir bei NAZET GmbH haben es uns zur Mission gemacht, durch präzisen Estrichbau und fortschrittliche Dämmungslösungen stabile und langlebige Grundlagen für jedes Bauprojekt zu schaffen.",

    "planTitle" => "Unser Plan",
    "planEngagingTitle" => "Individuelle Lösungen für jeden Bau",
    "planDescription" => "Unser Plan ist es, jeden Auftrag mit maßgeschneiderten Estrich- und Dämmtechniken anzugehen und durch Expertise und modernste Materialien Ergebnisse zu erzielen, die perfekt auf die Bedürfnisse unserer Kunden abgestimmt sind.",
