<?php
$translations = [
  "title" => "Abbruch,-Gebäudereinigung und Transport",
  "description" =>  "Erhöhen Sie Ihren Raum mit NAZET GmbH, dem Inbegriff für hervorragende Unterhaltsreinigungsdienste. Von häuslichen Heiligtümern bis hin zu Industrielandschaften sind wir spezialisiert auf Haushaltsreinigung, Glas- und Fensterreinigung, Teppich- und Polsterreinigung, Treppenhauspflege, industrielle Sauberkeit und mehr. Vertrauen Sie NAZET GmbH für erstklassige Büro-, Grund-, Gebäude- und Hotelreinigung sowie effiziente Abbruch- und Transportlösungen. Entdecken Sie einen neuen Standard der Sauberkeit mit NAZET GmbH - wo jede Dienstleistung ein Meisterwerk der Hygiene und Präzision ist.",
  "keywords" => "Unterhaltsreinigung, Haushaltsreinigung, Glasreinigung, Fensterreinigung, Teppichreinigung, Polsterreinigung, Treppenhausreinigung, Industriereinigung, Büroreinigung, Grundreinigung, Gebäudereinigung, Hotelreinigung, Abbrucharbeiten, Transportlösungen, Unverfälschte Umgebungen, Exzellente Reinigung, Professionelle Hygiene, NAZET GmbH-Reinigungsunternehmen, Erstklassige Reinigungsdienstleistungen.",
  ...
  "Why Us" => "Entfesseln Sie den NAZET GmbH-Vorteil",
  "Why Us Start" => "Wir reinigen nicht nur, wir schaffen Umgebungen von unvergleichlicher Sauberkeit und makelloser Schönheit. Hier ist der Grund, warum die Wahl von NAZET GmbH für Ihren Unterhaltsreinigungsbedarf eine Entscheidung ist, die über das Gewöhnliche hinausgeht:",
  "Why1" => "Umfassendes Fachwissen",
  "Why2" => "Aufmerksamkeit zum Detail",
  "Why3" => "Professionelle Präzision",
  "Why4" => "Geschneiderte Lösungen",
  "Why5" => "Innovation in Sachen Sauberkeit",
  "Why6" => "Zuverlässigkeit und Vertrauen",
  "Why7" => "Verpflichtung zur Nachhaltigkeit",
  "Why8" => "Kundenorientierter Ansatz",
  "Why End" => "Erleben Sie den NAZET GmbH-Vorteil noch heute.",

  "Happy Clients" => "Zufriedene Kunden",
  "Projects" => "Projekte",
  "Hours Of Support" => "Stunden der Unterstützung",
  "Hard Workers" => "Fleißige Arbeiter",

  "Our Mission" => "Unser Auftrag",
  "Our Mission Desc" => "Wir bei NAZET GmbH haben es uns zur Aufgabe gemacht, die Standards der Unterhaltsreinigung neu zu definieren, indem wir unvergleichliche Dienstleistungen anbieten, die die Erwartungen unserer Kunden nicht nur erfüllen, sondern übertreffen. Wir sind bestrebt, makellose Umgebungen zu schaffen, die zum Wohlbefinden und zur Zufriedenheit unserer Kunden beitragen und Räume schaffen, die Sauberkeit und Komfort ausstrahlen.",
  "Our Plan" => "Unser Plan",
  "Our Plan Desc" => "Unser Plan dreht sich um einen sorgfältigen und strategischen Ansatz für die Unterhaltsreinigung. Unser Ziel ist es, unsere Dienstleistungen auf die individuellen Bedürfnisse jedes einzelnen Kunden abzustimmen und dabei modernste Techniken und umweltfreundliche Verfahren einzusetzen. Durch die Umsetzung eines umfassenden Plans stellen wir sicher, dass jeder Raum, den wir betreten, in eine makellose Oase verwandelt wird und einen bleibenden Eindruck von Exzellenz hinterlässt.",
  "Our Vision" => "Unsere Vision",
  "Our Vision Desc" => "Wir bei NAZET GmbH haben die Vision, der führende Name in der Unterhaltsreinigung zu werden, anerkannt für unser Engagement für Qualität, Innovation und Kundenzufriedenheit. Wir stellen uns eine Zukunft vor, in der jedes Haus, jedes Büro und jeder Industrieraum den NAZET GmbH-Touch widerspiegelt - ein Zeichen von Sauberkeit, Präzision und der Hingabe, Umgebungen zu schaffen, die inspirieren und beeindrucken.",
...
Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z. B. um Daten handeln, die Sie beim Bestellprozess oder im Kontaktformular eingeben. Andere Daten werden automatisch beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.<br>
<br>
Wofür nutzen wir Ihre Daten?<br>
Ihre Daten werden erhoben, soweit dies zur Erfüllung und Abwicklung Ihrer Bestellung und/ oder zur Bearbeitung Ihrer Anfragen erforderlich ist. Ein weiterer Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.<br>
<br>
Welche Rechte haben Sie bezüglich Ihrer Daten?<br>
<br>
Sie haben jederzeit das Recht unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer gespeicherten personenbezogenen Daten zu erhalten. Sie haben außerdem ein Recht, die Berichtigung oder Löschung dieser Daten zu verlangen. Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit unter der im Impressum angegebenen Adresse oder über das Kontaktformular (unten auf der Titelseite, auf den Hyperlink „Kontakt“ klicken) an uns wenden. Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. <br>
<br>
...
Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail oder über das Kontaktformular (unten auf der Titelseite, auf den Hyperlink „Kontakt“ klicken) an uns. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt. <br>
<br>
...
Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum<br>
...
Um die Datenerfassung und -speicherung durch Google Analytics geräteübergreifend zu verhindern, können Sie einen Opt-Out-Cookie setzen. Opt-Out-Cookies verhindern die zukünftige Erfassung Ihrer Daten beim Besuch dieser Website. Sie müssen das Opt-Out auf allen genutzten Systemen und Geräten durchführen, damit dies umfassend wirkt. Wenn Sie das Opt-out-Cookie löschen, werden wieder Anfragen an Google übermittelt. Wenn Sie hier klicken, wird das Opt-Out-Cookie gesetzt: Google Analytics deaktivieren.<br>
Nähere Informationen zu Nutzungsbedingungen und Datenschutz finden Sie unter https://www.google.com/analytics/terms/de.html bzw. unter https://www.google.de/intl/de/policies/.<br>
Alternativ können Sie die Verwendung von Cookies durch Drittanbieter verhindern, indem sie die Deaktivierungsseite der Netzwerkwerbeinitiative (Network Advertising Initiative) unter https://www.networkadvertising.org/choices/ aufrufen und die dort genannten weiterführenden Information zum Opt-Out umsetzen.<br>
<br>
Nähere Informationen zu Google Remarketing sowie die dazugehörige Datenschutzerklärung finden Sie unter: https://www.google.com/privacy/ads/<br>
<br>
Verwendung von Google Ads Conversion-Tracking<br>
Wir verwenden auf unserer Website das Online-Werbeprogramm „Google Ads“ und in diesem Rahmen Conversion-Tracking (Besuchsaktionsauswertung). Das Google Conversion Tracking ist ein Analysedienst der Google Ireland Limited (Gordon House, Barrow Street, Dublin 4, Ireland). Wenn Sie auf eine von Google geschaltete Anzeige klicken, wird ein Cookie für das Conversion-Tracking auf Ihrem Rechner abgelegt. Diese Cookies haben eine begrenzte Gültigkeit, enthalten keine personenbezogenen Daten und dienen somit nicht der persönlichen Identifizierung. Wenn Sie bestimmte Seiten unserer Website besuchen und das Cookie noch nicht abgelaufen ist, können Google und wir erkennen, dass Sie auf die Anzeige geklickt haben und zu dieser Seite weitergeleitet wurden. Jeder Google Ads-Kunde erhält ein anderes Cookie. Somit besteht keine Möglichkeit, dass Cookies über die Websites von Ads-Kunden nachverfolgt werden können.<br>
<br>
Die Informationen, die mit Hilfe des Conversion-Cookie eingeholt werden, dienen dem Zweck Conversion-Statistiken zu erstellen. Hierbei erfahren wir die Gesamtanzahl der Nutzer, die auf eine unserer Anzeigen geklickt haben und zu einer mit einem Conversion-Tracking-Tag versehenen Seite weitergeleitet wurden. Wir erhalten jedoch keine Informationen, mit denen sich Nutzer persönlich identifizieren lassen. Ihre Daten werden gegebenenfalls in die USA übermittelt. Google hat sich nach dem US-EU-Datenschutzabkommen „Privacy Shield“ zertifiziert und damit verpflichtet, die europäischen Datenschutzrichtlinien einzuhalten. Sie können in den Einstellungen für Werbung bei Google für Sie personalisierte Werbung deaktivieren. Eine Anleitung dazu finden Sie unter https://support.google.com/ads/answer/2662922?hl=de.<br>
<br>
Alternativ können Sie die Verwendung von Cookies durch Drittanbieter verhindern, indem Sie die Deaktivierungsseite der Netzwerkwerbeinitiative (Network Advertising Initiative) unter https://www.networkadvertising.org/choices/ aufrufen und die dort genannten weiterführenden Information zum Opt-Out umsetzen.<br>
<br>
Sie werden sodann nicht in die Conversion-Tracking Statistiken aufgenommen.<br>
Nähere Informationen sowie die Datenschutzerklärung von Google finden Sie unter: https://www.google.de/policies/privacy/<br>
<br>
Verwendung von Facebook Remarketing<br>
Wir verwenden auf unserer Website die Remarketing-Funktion „Custom Audiences“ von Facebook und Instagram betrieben von Meta Platforms Ireland Limited (4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Dublin D02x525, Ireland). Die Anwendung dient dem Zweck die Besucher der Website zielgerichtet mit interessenbezogener Werbung im sozialen Netzwerk Facebook und Instagram anzusprechen. Dazu wurde auf der Website das Remarketing-Tag von Facebook und Instagramm implementiert. Über dieses Tag wird beim Besuch der Website eine direkte Verbindung zu den Facebook/Instagram-Servern hergestellt. Hierdurch wird an den Facebook/Instagramm-Server übermittelt, welche unserer Seiten Sie besucht haben. Facebook/Instagramm ordnet diese Information Ihrem persönlichen Facebook/Instagramm-Benutzerkonto zu. Wenn Sie das soziale Netzwerk Facebook/Instagramm besuchen, werden Ihnen dann personalisierte, interessenbezogene Facebook/Instagramm-Ads angezeigt.<br>
Ihre Daten werden gegebenenfalls nach Irland übermittelt. Facebook/Insagram bzw. Meta hat sich nach dem US-EU-Datenschutzabkommen „Privacy Shield“ zertifiziert und damit verpflichtet, die europäischen Datenschutzrichtlinien einzuhalten.<br>
<br>
...
<br>
Verwendung von Google AdSense<br>
Wir verwenden auf unserer Website die AdSense-Funktion der Google Ireland Limited (Gordon House, Barrow Street, Dublin 4, Ireland). Die Datenverarbeitung dient dem Zweck, Werbeflächen auf der Website zu vermieten und auf diesen die Besucher der Website zielgerichtet mit interessenbezogener Werbung anzusprechen.<br>
Mittels dieser Funktion werden den Besuchern der Website des Anbieters personalisierte, interessenbezogene Werbung-Anzeigen aus dem Google Display-Netzwerk geschaltet. Dabei verwendet Google Cookies, die eine Analyse der Benutzung der Website durch Sie ermöglichen.<br>
...
<br>
Sie können die Verwendung von Cookies durch Google dauerhaft deaktivieren, indem Sie dem nachfolgenden Link folgen und das dort bereitgestellte Plug-In herunterladen und installieren: https://support.google.com/ads/answer/7395996?hl=de.<br>
<br>
Alternativ können Sie die Verwendung von Cookies durch Drittanbieter verhindern, indem sie die Deaktivierungsseite der Netzwerkwerbeinitiative (Network Advertising Initiative) unter https://www.networkadvertising.org/choices/ aufrufen und die dort genannten weiterführenden Information zum Opt-Out umsetzen.<br>
<br>
Nähere Informationen sowie die Datenschutzerklärung von Google finden Sie unter: https://www.google.com/policies/technologies/ads/, https://www.google.de/policies/privacy/<br>
...
- an der Erfolgsmessung der Partnerwerbung und der damit einhergehenden korrekten Abrechnung der Provisionen im Rahmen des Partnerprogramms<br>
<br>
...
<br>
6. Newsletter Newsletterdaten <br>
<br>
