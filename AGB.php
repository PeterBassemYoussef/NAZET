...
<head>
  ...
  <title>NAZET GmbH - <?php echo $translations["Conditions"]; ?></title>
  ...
  <!-- meta -->
  <meta property="og:title" content="NAZET GmbH - <?php echo $translations["Conditions"]; ?>" />
  ...
  <meta name="twitter:title" content="NAZET GmbH - <?php echo $translations["Conditions"]; ?>">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><?php echo $translations["Conditions"]; ?></h2>
          <ol>
            <li><a href="index"><?php echo $translations["Home"]; ?></a></li>
            <li><?php echo $translations["Conditions"]; ?></li>
          </ol>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200">
            <h5 class="pre_class fst-italic"><?php echo $translations["Cookie Policy Title"]; ?></h5>
            <span class="pre_class fst-italic"><?php echo $translations["Cookie Policy Desc"]; ?></span>
          </div>
        </div>
